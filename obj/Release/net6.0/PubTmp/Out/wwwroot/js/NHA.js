var swiper = new Swiper(".mySwiper", {
    ...
    centeredSlides: true,
    slidesPerView: "auto",
    initialSlide: Math.floor($(".mySwiper .swiper-slide").length / 2.5), // Set initial slide to the middle
    coverflowEffect: {
        rotate: 0,
        stretch: 0,
        depth: 300,
...
$(document).ready(function () {
    ...
    runExeBtns.click(function () {
        ...
        $.ajax({
            type: "POST",
            url: '/Disability/HandleButtonClick', // Adjust the URL to match your controller route
